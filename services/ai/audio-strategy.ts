...
export const AUDIO_CAPABILITIES: Record<string, AudioCapableModel> = {
  "replicate/video-gen": {
    ...
    note: "The video model produces no audio. Sound is generated by Atheos from the finished clip and mixed in afterwards.",
  },
  "replicate/video-pro": {
...
export function resolveAudioStrategy(input: {
  ...
  return {
    ...
    label: "Atheos sound design added after generation",
    overridden: false,
  };
}
...
export function quoteAudio(input: {
  ...
  return {
    ...
    disclosure:
      "Sound is generated by Atheos from the finished video and mixed in, " +
      `which adds about ${SOUND_DESIGN_PROVIDER.typicalLatencySeconds} seconds after the video completes.`,
  };
}
